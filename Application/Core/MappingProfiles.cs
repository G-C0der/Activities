    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<ActivityAttendee, AttendeeDto>()
                ...
                .ForMember(d => d.TargetCount, o =>
                    o.MapFrom(s => s.AppUser.Targets.Count))
                .ForMember(d => d.Following, o =>
                    o.MapFrom(s => 
                        s.AppUser.Followers.Any(x => x.Follower.UserName == currentUserName)));
